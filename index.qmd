...
![](assets/cat-theme/09-cat.svg){.absolute width=500.68px height=500.68px left=856px top=-124px}
...
![](assets/cat-theme/17-cat.svg){.absolute width=388.38px height=458.723px left=702.059px top=-121.723px}

![](assets/cat-theme/19-cat.svg){.absolute width=438.34px height=445.185px left=91.4391px top=-122.232px}
...
![](assets/cat-theme/06-cat.svg){.absolute width=374.49px height=287.697px left=-103.568px top=116.572px}
...
![](assets/cat-theme/01-cat.svg){.absolute width=423.92px height=394.978px left=790.24px top=-334.572px}
...
![](assets/cat-theme/20-cat.svg){.absolute width=840.86px height=544.089px left=175.48px top=88.4244px}
...
![](assets/cat-theme/21-cat.svg){.absolute width=692.57px height=638.144px left=698.247px top=72px}
